...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, default="", max_length=6, verbose_name="Number of pages"),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name="book",
        ...
        migrations.AlterField(
            model_name="genre",
            name="help_text",
            field=models.CharField(blank=True, default="", max_length=250, verbose_name="Help text"),
            preserve_default=False,
        ),
    ]
