...
from village.models import DjangoVillageConfig, VillageSocialMedia
    ...
    def handle(self, *args, **options):
        ...
        config, _created = DjangoVillageConfig.objects.get_or_create(
            ...
            defaults={
                ...
                "footer_description": '<a href="https://github.com/numerique-gouv/django-village" \r\ntarget="_blank" rel="noreferrer noopener">Dépôt Github</a>',
                "mourning": False,
                ...
                "newsletter_url": "https://github.com/numerique-gouv/django_village/releases",
            },
        )
