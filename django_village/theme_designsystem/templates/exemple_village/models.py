...
class Author(models.Model):
    first_name = models.CharField(_("First name"), max_length=250, null=False, blank=False)
    last_name = models.CharField(_("Last name"), max_length=250, null=False, blank=False)
...
class Genre(models.Model):
    ...
    designation = models.CharField(_("Designation"), max_length=250, null=False, blank=False)
...
class Book(models.Model):
    ...
    book_format = models.CharField(_("Format"), choices=BOOK_FORMAT, max_length=10, blank=True)
