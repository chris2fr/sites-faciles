...
def signup_view(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            admin = KeycloakAdmin(
                server_url="https://keycloak.gdvox.com/",
            ...
            if user_id:
                ...
                # return 'https://keycloak.gdvox.com/realms/master/account/applications'
            email_users = admin.get_users({"email": context["email"]})
            if len(email_users) > 0:
                formdata["username"] = email_users[0]["username"]
                formdata["href"] = "https://keycloak.gdvox.com/realms/master/account/applications"
            ...
            if new_user:
                return redirect("https://keycloak.gdvox.com/realms/master/account/applications")
        else:
    ...
    # api_url = "https://keycloak.gdvox.com/admin/realms/master/users/count?username=%s" % userdata['username']
    # headers = {
