...
def signup_view(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if user_id:
                ...
                # return 'https://key.gv.je/realms/master/account/applications'
            email_users = admin.get_users({"email": context["email"]})
            if len(email_users) > 0:
                formdata["username"] = email_users[0]["username"]
                formdata["href"] = "https://key.gv.je/realms/master/account/applications"
            ...
            if new_user:
                return redirect("https://key.gv.je/realms/master/account/applications")
        else:
    ...
    # api_url = "https://key.gv.je/admin/realms/master/users/count?username=%s" % userdata['username']
    # headers = {
